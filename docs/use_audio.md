...
```
ENABLE_AUDIO = True
ALIYUN_TOKEN = "your-aliyun-token"    # 示例占位符，请替换为你自己的有效 token
ALIYUN_APPKEY = "your-aliyun-appkey"   # 示例占位符，请替换为你自己的有效 appkey
```
...
ALIYUN_TOKEN = ""
ALIYUN_ACCESSKEY = "your-aliyun-accesskey-id"
ALIYUN_SECRET = "your-aliyun-accesskey-secret"
```
